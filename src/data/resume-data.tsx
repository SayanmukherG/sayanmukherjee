...
export const RESUME_DATA = {
  ...
  locationLink: "",
  about:
    "Welcome to my homepage! I am currently a final year graduate student working on evolution and learning in games under the supervision of Prof. Souvik Roy.",
  summary:
